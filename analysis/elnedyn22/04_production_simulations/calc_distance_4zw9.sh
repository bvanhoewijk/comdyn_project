...
do
    ...
    #     -s ${tpr_file} \
    #     -f ${xtc_file} \
    #     -oall distances/4zw9/${item}_TM2_TM11_out_rep${i}.com.xvg \
    #     -n config/4zw9_distance.ndx \
    ...
    #     -s ${tpr_file} \
    #     -f ${xtc_file} \
    #     -oall distances/4zw9/${item}_TM2_TM11_in_rep${i}.com.xvg \
    #     -n config/4zw9_distance.ndx \
    ...
    #     -s ${tpr_file} \
    #     -f ${xtc_file} \
    #     -oall distances/4zw9/${item}_TM5_TM8_out_rep${i}.com.xvg \
    #     -n config/4zw9_distance.ndx \
    ...
    #     -s ${tpr_file} \
    #     -f ${xtc_file} \
    #     -oall distances/4zw9/${item}_TM5_TM8_in_rep${i}.com.xvg \
    #     -n config/4zw9_distance.ndx \
    #     -select 'com of group TM5_in plus com of group TM8_in'
    # gmx distance \
    #     -s ${tpr_file} \
    #     -f ${xtc_file} \
    #     -oall distances/4zw9/${item}_TM8_TM9_out_rep${i}.com.xvg \
    #     -n config/4zw9_distance.ndx \
    ...
    #     -s ${tpr_file} \
    #     -f ${xtc_file} \
    #     -oall distances/4zw9/${item}_TM8_TM9_in_rep${i}.com.xvg \
    #     -n config/4zw9_distance.ndx \
    #     -select 'com of group TM8_in plus com of group TM9_in'
    # gmx distance \
    #     -s ${tpr_file} \
    #     -f ${xtc_file} \
    #     -oall distances/4zw9/${item}_TM2_TM3_out_rep${i}.com.xvg \
    #     -n config/4zw9_distance.ndx \
    #     -select 'com of group TM8_out plus com of group TM9_out'
    ...
    #     -s ${tpr_file} \
    #     -f ${xtc_file} \
    #     -oall distances/4zw9/${item}_TM2_TM3_in_rep${i}.com.xvg \
    #     -n config/4zw9_distance.ndx \
