...
gmx mdrun -rdd 3.0 -deffnm step6.1_minimization
...
while [ $cnt -le $cntmax ]; do
    ...
    gmx mdrun -rdd 3.0 -deffnm step6.${cnt}_equilibration
    cnt=$((cnt + 1))
done

# Production
#gmx grompp -f step7_production.mdp -o step7_production.tpr -c step6.6_equilibration.gro -p system_martini3.top -n index.ndx
#gmx mdrun -rdd 3.0 -deffnm step7_production
