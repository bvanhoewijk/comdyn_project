...
mkdir -p rep1
gmx grompp -f step7_production.mdp -o rep1/step7_production_rep1.tpr -c step6.6_equilibration.gro -p system.top -n index.ndx -po rep1/mdout.mdp
gmx mdrun -deffnm rep1/step7_production_rep1 -cpt 1 -append
...
gmx mdrun -deffnm rep${rep}/step7_production_rep${rep} -cpt 1 -append -nt 2

# For resume
# gmx mdrun -append -cpi rep1/step7_production_rep1.cpt -deffnm rep1/step7_production_rep1